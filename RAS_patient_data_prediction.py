...
data = np.interp(-59.2, (resultC1[:, 0, -1, 3] - resultC1[:, 0, N3, 3])*(100/resultC1[:, 0, N3, 3]),ueACE2[:, 0, 0])
print(data/2793)
plt.scatter(data, -59.2, marker='s')
plt.errorbar(data, -59.2, yerr=15.8, elinewidth=2,capsize=6)
# ANGII
for i in range(number_of_cases):
    plt.scatter(ueACE2[i, 0, 0],(resultC1[i, 0, -1, 3] - resultC1[i, 0, N3, 3])*(100/resultC1[i, 0, N3, 3]), linewidth=2)


plt.plot(ueACE2[:, 0, 0],(resultC1[:, 0, -1, 3] - resultC1[:, 0, N3, 3])*(100/resultC1[:, 0, N3, 3]), linewidth=2)
plt.legend(['fit','data','200','400','600','800','1000','1200','1400','1600','1800','2000'], ncol =2, loc='lower right', prop={"size":15})
...
data = np.interp(-64.9, (resultC1[:, 0, -1, 4] - resultC1[:, 0, N3, 4])*(100/resultC1[:, 0, N3, 4]),ueACE2[:, 0, 0])
print(data/2793)
plt.scatter(data, -64.9, marker='s')
plt.errorbar(data, -64.9, yerr=12.9, elinewidth=2,capsize=6)


for i in range(number_of_cases):
    plt.scatter(ueACE2[i, 0, 0],(resultC1[i, 0, -1, 4] - resultC1[i, 0, N3, 4])*(100/resultC1[i, 0, N3, 4]), linewidth=2)

plt.plot(ueACE2[:, 0, 0],(resultC1[:, 0, -1, 4] - resultC1[:, 0, N3, 4])*(100/resultC1[:, 0, N3, 4]), linewidth=2)
#plt.legend(['fit','data','200','400','600','800','1000','1200','1400','1600','1800','2000'], loc='upper left', prop={"size":15})
plt.title('Kutz et al. ')
plt.xlabel('# of ueACE2')
plt.ylabel('% ANG1-7')
...
# unconverted ANGII
data = np.interp(50.6, abs(((resultC1[:, 0, -1, 3] - resultC1[:, 0, N3, 3])-(resultC2[:, 0, -1, 3] - resultC2[:, 0, N3, 3]))*(100/(resultC2[:, 0, -1, 3] - resultC2[:, 0, N3, 3]))),ueACE2[:, 0, 0])
print(data/2793)
plt.scatter(data, 50.6, marker='s')
plt.errorbar(data, 50.6, yerr=25, elinewidth=2,capsize=6)


for i in range(number_of_cases):
    plt.scatter(ueACE2[i, 0, 0],abs(((resultC1[i, 0, -1, 3] - resultC1[i, 0, N3, 3])-(resultC2[i, 0, -1, 3] - resultC2[i, 0, N3, 3]))*(100/(resultC2[i, 0, -1, 3] - resultC2[i, 0, N3, 3]))), linewidth=2)

#plt.legend(['200','400','600','800','1000','1200','1400','1600','1800','2000'], ncol=2, loc='lower right', prop={"size":15})
plt.plot(ueACE2[:, 0, 0],abs(((resultC1[:, 0, -1, 3] - resultC1[:, 0, N3, 3])-(resultC2[:, 0, -1, 3] - resultC2[:, 0, N3, 3]))*(100/(resultC2[:, 0, -1, 3] - resultC2[:, 0, N3, 3]))), linewidth=2)
plt.title('Liu et al. ')
plt.xlabel('# of ueACE2')
plt.ylabel('% Unconverted ANGII')
plt.savefig("ANGII_percentage"+str(counter2)+".png", dpi = 300, bbox_inches='tight')
plt.show()
